...
4. To download, click on the GlobalProtect Agent :numref:`(see red box) <webPortal>`.
...
5. On Windows - Select Continue installing from outside the Store :numref:`(see red box) <install>`.
...
11. Once installed, you should see the following pop-up :numref:`(see image) <vpnNOIP>` on your desktop.
...
12. Type vpn.princeton.edu in the text box :numref:`(see image) <vpnIP>`, click Connect.
